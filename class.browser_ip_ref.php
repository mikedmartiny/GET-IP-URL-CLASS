<?php
    class browser_ip_ref{
        ...
        function insertInfo($pageID, $version){
            ...
            // if ($num_rows == 0) {
            //     $this->_db->query("INSERT INTO `hit_counter_info` (`longIP`,`pageID`,`cc`,`browser`,`version`) VALUES ('".$this->_ip."', '".$pageID."', '".$countryID."', '".$browser."', '".$version."')");
            //     return true;
            // } else {
            // 	return false;
            // }

            return "INSERT INTO `hit_counter_info` (`longIP`,`pageID`,`cc`,`browser`,`version`) VALUES ('".$this->_ip."', '".$pageID."', '".$countryID."', '".$this->info['Browser']."', '".$this->info['Version']."')";
        }
